						...
						<div>
							...
							<div>
								...
								<div className="flex justify-end gap-x-3 mt-3">
									<button onClick={updateBtn} className="bg-[#0086ea] transition hover:bg-[#00A1C9]  px-4 py-1 text-[10.6px] tracking-wide text-[#fff]">
										Update
									</button>
									<button onClick={() => leaveGroup()} className="bg-[#880808] hover:bg-[#A52A2A] transition delay-150 px-4 py-1 text-[10.6px] tracking-wide text-[#fff]">
										Leave
									</button>
								</div>
							</div>
