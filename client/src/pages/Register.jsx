            ...
            >
              <div className="flex gap-x-2 w-[100%]">
                <input
                  ...
                  className="bg-[#515050] h-[50px] pl-3 text-[#ffff] w-[49%] sm:w-[47%]"
                  type="text"
                  name="firstname"
              ...
              <div className="relative flex flex-col">
                <input
                  onChange={handleOnChange}
                  className="bg-[#515050] h-[50px] pl-3 text-[#ffff] w-[100%] sm:w-[96.3%]"
                  type="email"
                  name="email"
                  placeholder="Email"
                ...
                {!showPass ? (
                  <button type="button">
                    <BsEmojiLaughing
                      ...
                      className="text-[#eae8d9] absolute top-3 right-4 sm:right-6 w-[30px] h-[25px]"
                    />
                  </button>
                ) : (
                  <button type="button">
